...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_BASE_HEROIC 
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Makerparts 2"
...
// chages applied by I. Perez and M. Barella on 30 nov 2019
...
// new difinition by M Passaglia on Dec 15, 2019
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 1, 8.3 }
/**
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
 // all values lowered by M Barella on Dec 15, 2019
//#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 10, 10000 }
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 7.5, 7500 }
 ...
 *    (0,0)
 */
// edited by M Passaglia and M Barella on Dec 15, 2019: Y position from -30 -> +30 (according to the example coordinetes)
// edited by M Barella on Dec 15, 2019. Measurements were performed. Also, changed the probe position to account for right Z zero.
...
#define XY_PROBE_SPEED 800 // Lo paso de 8000 a 800 (Ioni) Aca habia un error. Reportar 15/12/19 Como queria mover muy rapido los motores XY durante el homming se safaban
...
#define Z_MAX_POS 187 // edited by M. Barella on Dec 8, 2019
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (10*60) //Pasamos de 50*60 a 4*60 para tratar de solucionar problema, subo un poco para que sea más rapido
